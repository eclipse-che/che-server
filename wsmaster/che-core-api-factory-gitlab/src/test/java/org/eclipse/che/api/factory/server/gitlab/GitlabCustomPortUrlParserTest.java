...
public class GitlabCustomPortUrlParserTest {
  ...
  public Object[][] urls() {
    return new Object[][] {
      ...
      {"git@gitlab.custom.com:user/project/test1.git"},
      {"git@gitlab.custom.com:user/project1.git"},
      {"git@gitlab.custom.com:scm/project/test1.git"},
      {"git@gitlab.custom.com:user/project/"},
      {"git@gitlab.custom.com:user/project/repo/"},
    };
  }
  ...
  public Object[][] expectedParsing() {
    return new Object[][] {
      ...
      {"git@gitlab.custom.com:user/project1.git", "project1", "user/project1", null},
      {"git@gitlab.custom.com:user/project/test1.git", "test1", "user/project/test1", null},
      {
        "git@gitlab.custom.com:user/project/group1/group2/test1.git",
        "test1",
        "user/project/group1/group2/test1",
        null
      },
      {"git@gitlab.custom.com:user/project/", "project", "user/project", null},
      {"git@gitlab.custom.com:user/project/repo/", "repo", "user/project/repo", null},
      {
        "https://gitlab.custom.com:31280/user/project/-/tree/master/",
        "project",
        "user/project",
