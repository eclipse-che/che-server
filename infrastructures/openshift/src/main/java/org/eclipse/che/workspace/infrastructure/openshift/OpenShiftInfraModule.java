...
import org.eclipse.che.workspace.infrastructure.kubernetes.namespace.configurator.SshConfigConfigurator;
...
public class OpenShiftInfraModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    namespaceConfigurators.addBinding().to(SshConfigConfigurator.class);
    ...
    String kubernetesNamespacesCreation =
        System.getenv("CHE_INFRA_OPENSHIFT__KUBERNETES_NAMESPACES_CREATION");
    if (!"true".equalsIgnoreCase(kubernetesNamespacesCreation)) {
