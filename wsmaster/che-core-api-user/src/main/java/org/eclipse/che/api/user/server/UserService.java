...
public class UserService extends Service {
  ...
  public Response create(
      ...
      @Parameter(description ="User type") @QueryParam("temporary") @DefaultValue("false") Boolean isTemporary)
  ...
  public void updatePassword(
      @Parameter(description = "New password", required = true) @FormParam("password") String password)
  ...
  public UserDto find(
      @Parameter(description ="User email, if it is set then name shouldn't be") @QueryParam("email")
          String email,
      @Parameter(description ="User name, if is is set then email shouldn't be") @QueryParam("name") String name)
